        ...
        for (Email email : emails) {
            if (email.getCourriel().equals(courriel) && email.getMotDePasse().equals(motDePasse)) {
                ...
                if ("Utilisateur".equals(email.getType())) {
                    Utilisateur utilisateur = new Utilisateur(email.getCourriel(), email.getPseudo(), email.getMotDePasse(), email.getTelephone(), email.getNom(), email.getPrenom(), email.getNomDeCompagnie(), email.getInterets());
                    comptes.add(utilisateur);
                } else if ("Fournisseur".equals(email.getType())) {
                    Fournisseur fournisseur = new Fournisseur(email.getCourriel(), email.getPseudo(), email.getMotDePasse(), email.getTelephone(), email.getCapaciteFabrication());
